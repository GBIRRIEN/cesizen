...
import { getNextPhase, getPhaseLabel } from "../[id]/controller";
        ...
        <div className="flex flex-col items-center justify-center h-[80vh] px-6 text-center space-y-6">
            ...
            {hasStarted ? (
                <>
                    ...
                    <Button className="cursor-pointer" variant="destructive" onClick={handleStop}>Arrêter l'exercice</Button>
                </>
            ) : (
                <Button onClick={handleStart} className="bg-green-500 hover:bg-green-600 cursor-pointer">Démarrer</Button>
            )}
